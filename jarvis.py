...
class Jarvis(widget.Widget):
    def __init__(self, **kwargs):
        ...
        self.add_widget(image.Image(source='static/jarvis.gif', size=(self.min_size, self.min_size),
        ...
        self.title = label.Label(text='[b][color=3333ff]Nilesh Srivastava[/color][/b]', font_size=42, markup=True,
                                 font_name='static/dusri.ttf', pos=(920, 900))
        self.add_widget(self.title)

        self.subtitles_input = textinput.TextInput(
            text='Hey niles! I am your personal assistant',
            font_size=24,
            readonly=False,
    ...
    def handle_jarvis_commands(self, query):
        try:
            if "how are you" in query:
                ...
                notepad_path = "C:\\Users\\niles\\AppData\\Local\\Microsoft\\WindowsApps\\notepad.exe"
